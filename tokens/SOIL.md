...
## Identity
- Contract: [[ethereum]] `0x549913…cd16` (verified_same)
...
1 shadow trade · realized net **-0.37 USD** · win rate 0% (1 settled)

- 2026-07-19 · livescan · [[gateio]]→[[mexc]] · -0.37 USD · _price_drift_
...
_Machine region — rewritten by the sync bot from the live wiki (`https://nightwatch-v1-api.onrender.com/kg/SOIL.md`). Do not hand-edit inside these markers._
<!-- nw:auto:end -->
