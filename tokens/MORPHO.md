...
transfer: open
updated: 2026-08-05T03:56:24.324799Z
...
## Identity
- Contract: [[ethereum]] `0x58d97b…c2b2` (verified_same)
...
## Events
- 2026-07-25 · [[binance]] [[ethereum]] withdraw → open · [[event/dw-resume]]
...
- [[bybit]]: open:base,ethereum
- [[coinbase]]: open:base,ethereum
...
1 shadow trade · realized net **-1.21 USD** · win rate 0% (1 settled)

- 2026-08-03 · livescan · [[okx]]→[[kucoin]] · -1.21 USD · _price_drift_

_Paper / dry-run track record — trades are simulated with a 5-min simulated transfer window; no capital is deployed. See [[Thusus]]._

## Sources
nw_contract_verify sweep · scan_aggregate (NW grade) · nw_exchange_contracts (dep/wd) · tokens (listings) · nw_dw_status_log (events) · nw_paper_trades + nw_woncarry_shadow (Thusus track record)
_Live from the NightWatch Knowledge Graph · 2026-08-05T03:56:24.324799Z_

---
_Clone the full vault: https://github.com/jamboree777/thusus-vault_

_Machine region — rewritten by the sync bot from the live wiki (`https://nightwatch-v1-api.onrender.com/kg/MORPHO.md`). Do not hand-edit inside these markers._
<!-- nw:auto:end -->
